      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 divide-y md:divide-y-0 md:divide-x divide-white/20">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <h3 className="text-6xl md:text-7xl font-serif text-accent mb-4">{stat.value}</h3>
              <p className="text-xl font-light tracking-wide uppercase text-white/80">{stat.label}</p>
            </motion.div>
          ))}
